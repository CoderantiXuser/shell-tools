...
def parse_docstring(doc):
    ...
    args,returns={},""; current_section=None
    for line in lines[1:]:
        if line.lower().startswith("args:"): current_section="args"
            ...
            if match: name,type_hint,desc=match.groups(); args[name]={"type_hint":type_hint or "","desc":desc.strip()}
        elif current_section=="returns": returns+=line+" "
